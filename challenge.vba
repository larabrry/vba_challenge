...
For i = 2 To lastrow + 1
    ...
    If ws.Range("A" & i).Value <> strTicker Then
        ...
        'Add the previous ticker's close price to the variable
        ...
        'Add the previous ticker data to the summary table.
...
For i = 2 To lastrow + 1
    ...
    If Range("A" & i).Value <> strTicker Then
        ...
        Range("J" & nextSumRow).Value = Round(dblYearClose - dblYearOpen, 2)
        If Round(dblYearClose - dblYearOpen, 2) < 0 Then
         Range("J" & nextSumRow).Interior.Color = RGB(255, 0, 0)
         Else
         Range("J" & nextSumRow).Interior.Color = RGB(0, 255, 0)
        End If
        Range("K" & nextSumRow).Value = tmpPercChange
    ...
    End If
        ...
        dblStockVol = dblStockVol + Range("G" & i).Value
Next i

Range("P2").Value = dblGreatestPercIncTick
Range("Q2").Value = dblGreatestPercInc
 
Range("P3").Value = dblGreatestPerDecTick
Range("Q3").Value = dblGreatestPerDec
 
Range("P4").Value = dblGreatestTotalVolTick
Range("Q4").Value = dblGreatestTotalVol
